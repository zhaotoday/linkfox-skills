...
> This skill exposes multiple entry scripts: `check_auth_dependency.py`, `sb/list_ad_groups.py`, `sb/list_ads.py`, `sb/list_campaigns.py`, `sd/list_ad_groups.py`, `sd/list_campaigns.py`, `sd/list_creatives.py`, `sd/list_negative_targets.py`, `sd/list_product_ads.py`, `sd/list_targets.py`, `sp/list_ad_groups.py`, `sp/list_campaigns.py`, `sp/list_keywords.py`, `sp/list_negative_keywords.py`, `sp/list_product_ads.py`, `sp/list_targets.py`. Pass `--script scripts/<name>.py` to choose the one you need.
