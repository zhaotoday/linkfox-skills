...
> This skill exposes multiple entry scripts: `cancel_feed.py`, `check_auth_dependency.py`, `create_feed.py`, `create_feed_document.py`, `get_feed.py`, `get_feed_document.py`, `get_feeds.py`, `upload_feed_document.py`. Pass `--script scripts/<name>.py` to choose the one you need.
