...
> This skill exposes multiple entry scripts: `check_auth_dependency.py`, `get_report.py`, `merge_report_type_values_from_cache.py`. Pass `--script scripts/<name>.py` to choose the one you need.
