...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_ads_searchrec_ad_modify.py` |
...
python scripts/eu_ads_searchrec_ad_modify.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"status": 4, "modifyAdDTO": {"goodsId": 100001, "budget": 8000, "roas": 400}}}'
```
