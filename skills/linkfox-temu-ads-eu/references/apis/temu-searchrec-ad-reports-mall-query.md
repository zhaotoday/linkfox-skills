...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_ads_searchrec_ad_reports_mall_query.py` |
...
python scripts/eu_ads_searchrec_ad_reports_mall_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"startTs": 1714521600000, "endTs": 1714607999999}}'
```
