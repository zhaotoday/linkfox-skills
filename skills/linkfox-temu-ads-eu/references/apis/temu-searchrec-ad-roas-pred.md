...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_ads_searchrec_ad_roas_pred.py` |
...
python scripts/eu_ads_searchrec_ad_roas_pred.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"goodsInfoList": [{"goodsId": 100001}]}}'
```
