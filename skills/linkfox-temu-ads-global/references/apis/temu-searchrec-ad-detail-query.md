...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_ads_searchrec_ad_detail_query.py` |
...
python scripts/global_ads_searchrec_ad_detail_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"goodsList": [100001, 100002]}}'
```
