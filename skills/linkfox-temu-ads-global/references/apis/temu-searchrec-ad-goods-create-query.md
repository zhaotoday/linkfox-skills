...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_ads_searchrec_ad_goods_create_query.py` |
...
python scripts/global_ads_searchrec_ad_goods_create_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"goodsIdList": [100001, 100002]}}'
```
