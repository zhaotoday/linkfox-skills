...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_ads_searchrec_ad_log_query.py` |
...
python scripts/global_ads_searchrec_ad_log_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"goodsId": 100001, "startTime": 1714521600000, "endTime": 1714607999999}}'
```
