...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_co_warehouse_cooperativewarehouse_fulfill_submit.py` |
...
> - **`orderSn`** / **`parentOrderSn`** 等通常来自 **`linkfox-temu-order-eu`** 订单接口。  
...
python scripts/eu_co_warehouse_cooperativewarehouse_fulfill_submit.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "managementType": "semi-managed",
  "request": {
