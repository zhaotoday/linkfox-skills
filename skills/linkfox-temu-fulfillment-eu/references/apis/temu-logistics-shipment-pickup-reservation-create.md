...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_buy_shipping_logistics_shipment_pickup_reservation_create.py` |
...
python scripts/eu_buy_shipping_logistics_shipment_pickup_reservation_create.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "pickupStartTime": 1717200000,
