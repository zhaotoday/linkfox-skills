...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_co_warehouse_cooperativewarehouse_fulfill_submit.py` |
...
> - **`orderSn`** / **`parentOrderSn`** 等通常来自 **`linkfox-temu-order-global`** 订单接口。  
...
python scripts/global_co_warehouse_cooperativewarehouse_fulfill_submit.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "managementType": "semi-managed",
  "request": {
