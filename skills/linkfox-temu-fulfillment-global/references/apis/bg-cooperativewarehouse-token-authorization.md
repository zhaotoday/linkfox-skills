...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_co_warehouse_cooperativewarehouse_token_authorization.py` |
...
python scripts/global_co_warehouse_cooperativewarehouse_token_authorization.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "cwAppKey": "YOUR_CW_APP_KEY",
