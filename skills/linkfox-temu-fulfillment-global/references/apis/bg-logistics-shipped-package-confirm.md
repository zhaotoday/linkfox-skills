...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_buy_shipping_logistics_shipped_package_confirm.py` |
...
5. linkfox-temu-order-global                        → 刷新订单状态
```
...
python scripts/global_buy_shipping_logistics_shipped_package_confirm.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "packageSendInfoList": [
