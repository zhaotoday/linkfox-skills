...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_buy_shipping_logistics_label_list_get.py` |
...
5. temu_global_file_download                     → 下载面单文件
```
...
python scripts/global_buy_shipping_logistics_label_list_get.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "pageNumber": 1,
