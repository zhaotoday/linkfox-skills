...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_buy_shipping_logistics_shipment_pickup_reservation_cancel.py` |
...
python scripts/global_buy_shipping_logistics_shipment_pickup_reservation_cancel.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "reservationSn": "RSV-20260101001"
