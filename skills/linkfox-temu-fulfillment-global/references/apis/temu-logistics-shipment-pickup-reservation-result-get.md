...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_buy_shipping_logistics_shipment_pickup_reservation_result_get.py` |
...
python scripts/global_buy_shipping_logistics_shipment_pickup_reservation_result_get.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "packageSnList": ["PKG-001", "PKG-002"]
