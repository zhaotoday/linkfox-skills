...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_self_fulfilled_logistics_companies_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=38e79b35d2cb463d85619c1c786dd303&sub_menu_code=97bf9f5f4f454a589fb3192725bfeb7a |
...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| regionId | INTEGER | **是** | Region ID（区域 ID）。完整编码表见 Partner 文档：[regionId 编码说明](https://partner.temu.com/documentation?menu_code=38e79b35d2cb463d85619c1c786dd303&sub_menu_code=97bf9f5f4f454a589fb3192725bfeb7a)。美国站常用示例：**211**（USA，与 `linkfox-temu-order-us` 订单接口一致）。 |
...
# 专用脚本（美国站 regionId=211）
python scripts/us_self_fulfilled_logistics_companies_get.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "regionId": 211
...
1. 从订单接口（如 `bg.order.detail.v2.get`）或业务上下文确认 **`regionId`**（美国站多为 **211**）。
