...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_buy_shipping_logistics_label_list_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=746951536ea1455faaf17ae9d60e5b34&sub_menu_code=df97424d08f641f7adf942aa5accde3b |
...
5. temu_us_file_download                     → 下载面单文件
```
...
python scripts/us_buy_shipping_logistics_label_list_get.py '{
  "accessToken": "TOKEN",
  "tokenPurpose": "order-shipping",
  "request": {
    "pageNumber": 1,
