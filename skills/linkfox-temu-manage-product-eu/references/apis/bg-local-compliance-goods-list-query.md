...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_compliance_list_query.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=cf3e1c09736d4f1f96c4b0016b2af52d |
...
```bash
python scripts/eu_manage_compliance_list_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "pageNo": 1,
    "pageSize": 25,
