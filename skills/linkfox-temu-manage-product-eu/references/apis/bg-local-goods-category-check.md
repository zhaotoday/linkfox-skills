...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_category_check.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=fbcf3afb3eac4f039e30982ca5641033 |
...
```bash
python scripts/eu_manage_category_check.py '{
  "accessToken": "TOKEN",
  "request": {
    "catId": 12345,
