...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_compliance_edit.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=4499655e8cb044a0b8a30f9c9994f723 |
...
| `linkfox-temu-add-product-eu` 发品文档 | `certificationInfo` 与本文 `certificateInfo` 等同族结构参考 |
...
```bash
python scripts/eu_manage_compliance_edit.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456789,
    "certificateInfo": {
