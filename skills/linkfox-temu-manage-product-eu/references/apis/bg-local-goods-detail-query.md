...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_detail_query.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=50a6dd012fcd41149a2d8ef2cdc58b69 |
...
python scripts/eu_manage_detail_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456
  }
