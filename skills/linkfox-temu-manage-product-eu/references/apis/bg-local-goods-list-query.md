...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_list_query.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=43baaa509c4b4b419853558a613715de |
...
```bash
python scripts/eu_manage_list_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "pageNo": 1,
    "pageSize": 20,
