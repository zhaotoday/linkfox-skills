...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_out_sn_set.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=b203fc2bdde346239dbb51da1dc2e713 |
...
```bash
python scripts/eu_manage_out_sn_set.py '{
  "accessToken": "TOKEN",
  "request": {
    "modifyList": [
      {
