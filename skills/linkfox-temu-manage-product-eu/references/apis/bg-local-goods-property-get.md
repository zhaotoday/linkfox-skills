...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_property_get.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=42cd0095f6964ed88a2750bf8f005809 |
...
|----|----------------------------------------|----------------------------------------------------------|
| 所在 skill | manage-product-eu | add-product-eu |
...
```bash
python scripts/eu_manage_property_get.py '{
  "accessToken": "TOKEN",
  "request": {
