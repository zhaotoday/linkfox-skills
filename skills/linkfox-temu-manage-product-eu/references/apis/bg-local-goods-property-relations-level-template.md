...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_property_relations_level_template.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=ef845cd5342c4dc7b0c44c2f361abfbb |
...
```bash
python scripts/eu_manage_property_relations_level_template.py '{
  "accessToken": "TOKEN",
  "request": {
    "catId": 12345,
    "relationType": 1
