...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_sale_status_set.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=40fd5e090dbb4a3790d1c2b88223ec5e |
...
```bash
# 整品上架
python scripts/eu_manage_sale_status_set.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456789,
    "onsale": 1,
