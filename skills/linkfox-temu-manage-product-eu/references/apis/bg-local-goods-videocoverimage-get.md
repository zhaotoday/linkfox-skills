...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_videocoverimage_get.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=4759c1207d8940bf8dd09eaad1cc853f |
...
```bash
python scripts/eu_manage_videocoverimage_get.py '{
  "accessToken": "TOKEN",
  "request": {
