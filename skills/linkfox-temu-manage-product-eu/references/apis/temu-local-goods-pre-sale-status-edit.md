...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_pre_sale_status_edit.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=c3173683180c42e19b12f48c903e2f98 |
...
```bash
python scripts/eu_manage_pre_sale_status_edit.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456789,
    "targetPreSaleStatus": 1,
