...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_sku_stock_query.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=d2c3a9ad5fe7428b8ac5953b769a2c00 |
...
```bash
python scripts/eu_manage_sku_stock_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456
  }
