...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_manage_sku_list_retrieve.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=7289390cfd724be4a196f11ebe45a896&sub_menu_code=4b8fcc68f0f4463ab59225d677301413 |
...
```bash
python scripts/eu_manage_sku_list_retrieve.py '{
  "accessToken": "TOKEN",
  "request": {
    "pageSize": 25,
    "skuSearchType": "ACTIVE",
