...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_manage_goods_update.py` |
| **Partner 文档** | https://partner-global.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=b05f4b7598fb4dc7ac47c864aa5d5fc4 |
...
```bash
# 先查详情，再组完整 request
python scripts/global_manage_detail_query.py '{"accessToken":"TOKEN","goodsId":123456}'

python scripts/global_manage_goods_update.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456,
    "language": "en",
