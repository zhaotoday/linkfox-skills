...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_manage_sku_stock_query.py` |
| **Partner 文档** | https://partner-global.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=f14a3f28b654441b80f90e76a0a77c6e |
...
```bash
python scripts/global_manage_sku_stock_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456
  }
