...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_manage_detail_query.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=9ebbd5d269014322ad4a6c123b1dfdae |
...
python scripts/us_manage_detail_query.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456
  }
