...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_manage_publish_status_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=1d70452c1eba40a2b2382fb08833ae4e |
...
```bash
python scripts/us_manage_publish_status_get.py '{
  "accessToken": "TOKEN",
  "request": {
