...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_manage_goods_delete.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=97853cce1f5140e0aa302b5e530a8c99 |
...
```bash
python scripts/us_manage_goods_delete.py '{
  "accessToken": "TOKEN",
  "request": {
    "goodsId": 123456
  }
