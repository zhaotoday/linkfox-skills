...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_manage_goods_list_retrieve.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=7b50a3af47824c4482c7238c6e11aedc |
...
```bash
python scripts/us_manage_goods_list_retrieve.py '{
  "accessToken": "TOKEN",
  "request": {
    "pageSize": 25,
    "goodsSearchType": "ACTIVE",
