...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_manage_spec_info_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=fb16b05f7a904765aac4af3a24b87d4a&sub_menu_code=1094942488d844acaf9d7a3f2c097acd |
...
```bash
python scripts/us_manage_spec_info_get.py '{
  "accessToken": "TOKEN",
  "request": {
    "specIdList": [1001, 1002],
    "language": "en"
