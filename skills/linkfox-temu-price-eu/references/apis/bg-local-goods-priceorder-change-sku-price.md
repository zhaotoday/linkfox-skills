...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_price_priceorder_change_sku_price.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=dfff38c23adf498d8a7cd55052bd3648（`sub_menu_code` 请在 Partner EU 后台按 `bg.local.goods.priceorder.change.sku.price` 打开） |
