...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_price_baseprice_recommend.py` |
| **Partner 文档** | https://partner-eu.temu.com/documentation?menu_code=dfff38c23adf498d8a7cd55052bd3648（`sub_menu_code` 请在 Partner EU 后台按 `temu.local.goods.baseprice.recommend` 打开） |
...
> 欧洲站尺寸/重量单位建议：`weightUnit=lb`、`dimensionUnit=inch`；`goodsBasicInfo.catId` 须为**叶子类目**。
