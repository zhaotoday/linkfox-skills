...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_promotion_activity_candidate_goods_query.py` |
...
python scripts/eu_promotion_activity_candidate_goods_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"activityId": 123456, "pageNumber": 1, "pageSize": 20}}'
```
