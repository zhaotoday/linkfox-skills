...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_promotion_activity_goods_enroll.py` |
...
python scripts/eu_promotion_activity_goods_enroll.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"activityId": 123456, "enrollGoods": {"goodsId": 100001, "activityQuantity": 50, "traceCode": "enroll-001", "enrollSkuList": [{"skuId": 200001, "activitySupplierPrice": 1999}]}}}'
```
