...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_promotion_activity_goods_operation_query.py` |
...
python scripts/eu_promotion_activity_goods_operation_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"draftIdList": [10001, 10002]}}'
```
