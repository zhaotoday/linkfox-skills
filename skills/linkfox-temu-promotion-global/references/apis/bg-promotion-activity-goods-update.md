...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_promotion_activity_goods_update.py` |
...
python scripts/global_promotion_activity_goods_update.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"activityId": 123456, "goodsId": 100001, "operateType": 10, "traceCode": "update-001", "updateSkuList": [{"skuId": 200001, "activitySupplierPrice": 1899}]}}'
```
