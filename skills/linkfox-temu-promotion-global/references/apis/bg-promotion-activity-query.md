...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_promotion_activity_query.py` |
...
python scripts/global_promotion_activity_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"pageNumber": 1, "pageSize": 20, "activityType": 2, "activityStatus": 2, "onlyQueryJoinedActivity": false}}'
```
