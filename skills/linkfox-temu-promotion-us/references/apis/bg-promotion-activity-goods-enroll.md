...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_promotion_activity_goods_enroll.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=873ac072a78249c893e5f8d0e656a11f&sub_menu_code=27a87ec9d0d94273a48096c050f17854 |
...
python scripts/us_promotion_activity_goods_enroll.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"activityId": 123456, "enrollGoods": {"goodsId": 100001, "activityQuantity": 50, "traceCode": "enroll-001", "enrollSkuList": [{"skuId": 200001, "activitySupplierPrice": 1999}]}}}'
```
