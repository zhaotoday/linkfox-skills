...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_promotion_activity_goods_query.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=873ac072a78249c893e5f8d0e656a11f&sub_menu_code=08f3f87d05a24bac882732141e0d9672 |
...
python scripts/us_promotion_activity_goods_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"activityId": 123456, "pageNumber": 1, "pageSize": 20}}'
```
