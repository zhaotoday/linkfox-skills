...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_promotion_activity_query.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=873ac072a78249c893e5f8d0e656a11f&sub_menu_code=05820fed7179430c8e353905692d51b6 |
...
python scripts/us_promotion_activity_query.py '{"accessToken": "TOKEN", "tokenPurpose": "product-inventory", "request": {"pageNumber": 1, "pageSize": 20, "activityType": 2, "activityStatus": 2, "onlyQueryJoinedActivity": false}}'
```
