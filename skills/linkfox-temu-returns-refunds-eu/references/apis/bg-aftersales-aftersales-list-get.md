...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_returns_refunds_aftersales_aftersales_list_get.py` |
...
python scripts/eu_returns_refunds_aftersales_aftersales_list_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"pageNo": 1, "pageSize": 20, "parentAfterSalesSnList": ["PAS-001"]}}'
```
