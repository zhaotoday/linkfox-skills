...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/eu_returns_refunds_aftersales_signature_get.py` |
...
python scripts/eu_returns_refunds_aftersales_signature_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {}}'
```
