...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_returns_refunds_aftersales_parentreturnorder_get.py` |
...
python scripts/global_returns_refunds_aftersales_parentreturnorder_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"parentAfterSalesSn": "PAS-001", "afterSalesSn": "AS-001"}}'
```
