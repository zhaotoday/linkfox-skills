...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_returns_refunds_aftersales_carrier_get.py` |
...
python scripts/global_returns_refunds_aftersales_carrier_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"returnWarehouseRegionId1": 1}}'
```
