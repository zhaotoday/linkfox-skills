...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/global_returns_refunds_aftersales_parentaftersales_detail_get.py` |
...
python scripts/global_returns_refunds_aftersales_parentaftersales_detail_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"parentOrderSn": "PO-001", "parentAfterSalesSn": "PAS-001"}}'
```
