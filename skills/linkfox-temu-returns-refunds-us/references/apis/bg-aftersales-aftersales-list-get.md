...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_returns_refunds_aftersales_aftersales_list_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=d3d2812d87034d35adb016972349fcb0&sub_menu_code=d1675103eeed444fa3d650aa33b462be |
...
python scripts/us_returns_refunds_aftersales_aftersales_list_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"pageNo": 1, "pageSize": 20, "parentAfterSalesSnList": ["PAS-001"]}}'
```
