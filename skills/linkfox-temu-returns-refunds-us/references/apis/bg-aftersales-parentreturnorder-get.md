...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_returns_refunds_aftersales_parentreturnorder_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=d3d2812d87034d35adb016972349fcb0&sub_menu_code=986d1dc0ad9d4d44a380b8078405bae2 |
...
python scripts/us_returns_refunds_aftersales_parentreturnorder_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"parentAfterSalesSn": "PAS-001", "afterSalesSn": "AS-001"}}'
```
