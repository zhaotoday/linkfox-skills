...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_returns_refunds_aftersales_carrier_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=d3d2812d87034d35adb016972349fcb0&sub_menu_code=c1eceff2f3434bef8246668cc557ebb5 |
...
python scripts/us_returns_refunds_aftersales_carrier_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"returnWarehouseRegionId1": 1}}'
```
