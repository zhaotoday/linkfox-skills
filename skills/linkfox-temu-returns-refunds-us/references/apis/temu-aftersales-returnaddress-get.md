...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_returns_refunds_aftersales_returnaddress_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=d3d2812d87034d35adb016972349fcb0&sub_menu_code=05d0a325704d4d538d708f3e256168e0 |
...
python scripts/us_returns_refunds_aftersales_returnaddress_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {"parentAfterSalesSn": "PAS-001"}}'
```
