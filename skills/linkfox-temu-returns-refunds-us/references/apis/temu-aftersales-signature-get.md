...
| 项 | 值 |
|----|-----|
| **脚本** | `scripts/us_returns_refunds_aftersales_signature_get.py` |
| **Partner 文档** | https://partner-us.temu.com/documentation?menu_code=d3d2812d87034d35adb016972349fcb0&sub_menu_code=026c7431ac634dec9da8d7ab3c5a4825 |
...
python scripts/us_returns_refunds_aftersales_signature_get.py '{"accessToken": "TOKEN", "tokenPurpose": "order-shipping", "request": {}}'
```
