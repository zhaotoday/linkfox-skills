#!/usr/bin/env python3
"""
TikTok Shop Store Tokens Query - LinkFox Skill
Calls the /tiktokShop/storeTokens endpoint to read stored access/refresh tokens.

Usage:
  python store_tokens.py '{"openId": "7010736057180325637", "appType": "erp"}'
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print(
            'Example: store_tokens.py \'{"openId": "7010736057180325637", "appType": "erp"}\'',
            file=sys.stderr,
        )
        sys.exit(1)
